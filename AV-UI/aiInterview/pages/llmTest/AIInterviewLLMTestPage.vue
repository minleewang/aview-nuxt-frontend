...
//면접 종료시 여기로 돌아와서 결과 보여줄 계획, 면접 종료 시 local에 저장한 interviewInfo 삭제제
//const handleFinishInterview = () => {
//localStorage.removeItem('interviewInfo'); // 수동 삭제
//router.push('/'); // 예를 들어 홈으로 보내기
//};
